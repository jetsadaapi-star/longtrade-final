...
export default function CourseDetailClient({ course }: Props) {
  ...
  }, [course, unlocked, allLessons, refreshKey]);

  const allDone = unlocked && doneCount === totalLessons;

  const tryUnlock = () => {
    const expected = (course.unlock_code || "").trim();
  ...
  // Default instructor if not provided
  const instructor = {
    name: "โค้ชทิว",
    role: "Coach",
    avatar: "/instructors/tiw.jpg"
  };
    ...
    <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 space-y-6">
        <div className="glass rounded-2xl p-5 border border-white/10">
          <div className="text-white/90">{course.description}</div>
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-white/70">{instructor.role}</div>
            </div>
          </div>
        </div>
                            ...
                            <div className="flex items-center justify-between rounded-xl border border-white/10 px-3 py-2 bg-black/20">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <button
                                  ...
                                  className={`rounded-lg px-2 py-1 text-xs border ${done
